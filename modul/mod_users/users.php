  ...
  default:
    ...
    while ($r=mysqli_fetch_array($tampil)){
       echo "<tr><td>$no</td>
            ...
            <td class='center'>
              <a href='?module=user&act=edituser&id=$r[id_user]' class='btn btn-sm btn-warning'><span class='glyphicon glyphicon-edit' aria-hidden='true'></span> Edit</a>

              <a href='?module=user&act=deleteuser&id=$r[id_user]' class='btn btn-sm btn-danger'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span> Delete</a>
